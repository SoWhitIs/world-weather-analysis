# _ *Map IT!*_  || PlanMyTrip, Hotel and Lodging App WeatherPy Analysis  
...
A user prompt was coded to reutrn "real-time" results based inputted minimum and maximum temperature criteria. 
